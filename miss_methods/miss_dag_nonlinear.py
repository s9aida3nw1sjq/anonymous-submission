...
def miss_dag_nonlinear(X, B_true, dag_init_method, dag_method, em_iter=10, equal_variances=True):
    """
    ...
    for m in range(1, em_iter + 1):
        ...
        ####### E-step #######
        X_sampling, num_index, weight_index = E_step(X, model, sigma, equal_variances)
        ####### E-step #######
